...
export const metadata: Metadata = {
  title: {
    default: "Afisofftech CRM",
    template: "%s — Afisofftech CRM",
  },
  description: "Afisofftech CRM — a WhatsApp CRM for shared inbox, contacts, pipelines, broadcasts, and automations.",
  robots: {
    index: false,
    follow: false,
  },
