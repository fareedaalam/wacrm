...
- [GitHub Security Advisories](https://github.com/fareedaalam/wacrm/security/advisories/new)
  (preferred — keeps the disclosure, fix, and CVE all in one place).
- Email: `afiloops@gmail.com` with `[Afisofftech CRM security]` in the subject.
...
In scope:
- Anything in this repository (`fareedaalam/wacrm`), including webhook and auth
